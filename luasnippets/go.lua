...
local forrange = s({trig = "forr%s+(%S+)", regTrig = true, hidden = true},
                   fmt([[
		for {} := range {} {{
			{}
		}}
...
local if_err_check = s("ife-", fmt([[
    ...
    c(1, {t("_, err"), t("err")}), i(2, "obj"), i(3, "Meth"), i(4, "args"),
    d(5, function(import)
        return sn(nil, {
            i(1), t([[, fmt.Errorf("]]), t(import[1][1]), t([[: %w", err)]])
        })
    end, {3})
}))
...
local append = s({trig = "ap%s+(%S+)", regTrig = true, hidden = true}, fmt([[
    ...
    d(1, function(_, snip) return sn(1, i(1, snip.captures[1])) end), rep(1),
    i(0)
}))
...
local func = s({trig = "fn%s+(.+)", regTrig = true, hidden = true}, fmt([[
    ...
    f(function(index) return index[1] end, {2}), c(1, {
        t(""),
        sn(nil, {t("("), i(1), t(" "), c(2, {t(""), t("*")}), i(3), t(")")})
    }), d(2, function(_, snip) return sn(1, i(1, snip.captures[1])) end), i(3),
    c(4, {
...
local make_slice_or_map = s({
    ...
    end, {1}), d(1, function(_, snip) return sn(1, i(1, snip.captures[1])) end),
    c(2, {
        sn(nil, {i(1)}), sn(nil, {t(","), r(1, "lenArr", i(1, "0"))}),
...
local if_err = s({trig = "ife"}, fmt([[
    ...
    c(1, {
        sn(nil, {i(1)}), sn(nil, {
            t([[fmt.Errorf("]]), r(1, "errFunc", i(1, "errFunc")),
            t([[: %w", err)]])
        }),
        sn(nil,
