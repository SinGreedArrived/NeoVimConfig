...
map('n', '<F8>', '<cmd>GoBreakToggle<CR>', default_opts)
map('n', '<F9>', '<cmd>GoDebug<CR>', default_opts)
map('n', '<F10>', '<cmd>GoDebug -t<CR>', default_opts)
map('n', '<F11>', '<cmd>GoDebug -s<CR><cmd>so ~/.config/nvim/lua/greed/golang/ray-x/keymap.lua<CR>', default_opts)
